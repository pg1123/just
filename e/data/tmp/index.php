...
<div id="container">
  <div class="header clearfix ctnt">
    ...
    <ul class="layui-nav">
      ...
      <li class="layui-nav-item"> <a href="">软件/插件</a> </li>
      <li class="layui-nav-item"> <a href="">教程</a> </li>
      <li class="layui-nav-item"> <a href="">模型</a> </li>
      <li class="layui-nav-item"> <a href="">贴图/后期</a> </li>
  ...
  <div id="main">
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
      ...
      <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
          ...
          <div class="more"><a href="#">查看全部项目</a></div>
        </div>
    ...
    <div class="cgi cgiall">
      ...
      <div class="layui-row flow-default" id="LAY_demo1">
            <div class="layui-col-xs3">
