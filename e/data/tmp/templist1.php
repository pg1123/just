 ...
 <form id="login_form" class="layui-form" method="post" action="/e/member/doaction.php">
  ...
  <div class="list">
    <div class="choose clearfix">
       ...
       <span <?php if(!isset($_GET['orderby']) or ($_GET['all'] == 1)){ echo 'class="this"'; }  ?>><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&orderby=onclick&all=1">全部</a></span>
       <span <?php if($_GET['orderby'] == 'newstime'){ echo 'class="this"'; }  ?>  ><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&orderby=newstime">最新</a></span>
       <span <?php if($_GET['orderby'] == 'diggtop'){ echo 'class="this"'; }  ?> ><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&orderby=diggtop">人气</a></span>
       <span <?php if($_GET['orderby'] == 'onclick' and !isset($_GET['all'])){ echo 'class="this"'; }  ?> ><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&orderby=onclick">点击</a></span>
       <span <?php if($_GET['orderby'] == 'plnum'){ echo 'class="this"'; }  ?> ><a href="[!--news.url--]e/action/ListInfo.php?classid=[!--self.classid--]&orderby=plnum">回复</a></span>
    </div>
