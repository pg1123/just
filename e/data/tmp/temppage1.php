...
.header .login{ position:absolute ; right:20px; top:20px;color:#c4c5c9;}
...
.cgia{ margin-bottom:26px;}
.cginew{ padding:10px 0; padding-top:0;}
.cginew .layui-row{margin:0 -8px;}
.cginew .layui-row .border{ width:20%; float:left;}
.cginew .layui-row .grid-demo{ border:1px solid #ddd;  background-color:#fff; float:left; margin:0 8px;margin-bottom:16px;}
.cginew .layui-row a.show{overflow:hidden;position:relative;  display:block;}
.layui-tab-item{ display:block;}
...
.list .cginew{width:90%; padding:0 5%; margin:0 auto;}
...
@media(min-width:1600px){
    .cgiall .layui-col-xs3{ width:16.666%;}
    }
