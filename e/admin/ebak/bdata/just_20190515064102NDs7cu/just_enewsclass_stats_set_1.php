...
E_D("DROP TABLE IF EXISTS `just_enewsclass_stats_set`;");
E_C("CREATE TABLE `just_enewsclass_stats_set` (
...
E_D("replace into `just_enewsclass_stats_set` values('0','3600','0','20170227');");
